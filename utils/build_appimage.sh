...
OUTPUT=Endless_Sky-continuous-x86_64.AppImage ./linuxdeploy --appdir AppDir -e "$1/endless-sky" -d resources/endless-sky.desktop -i endless-sky.png --output appimage
